...
def admin_login(request):
    return render(request,"p_admin/login.html")
...
def admin_home(request):
    return render(request, "p_admin/admin_home.html")
...
def open_state(request):
    return render(request,'p_admin/open_state.html',{"sf":StateForm(),"sdata":StateModel.objects.all()})
...
def save_state(request):
    ...
    if sf.is_valid():
        ...
        return render(request,"p_admin/open_state.html",{"sf":sf})
...
def update_state(request):
    ...
    return render(request,"p_admin/open_state.html",{"update_data":d1,"sdata":StateModel.objects.all()})
...
def open_city(request):
    return render(request,'p_admin/open_city.html',{"sf":CityForm(),"cdata":CityModel.objects.all()})
...
def save_city(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "p_admin/open_city.html", {"sf": sf})


def update_city(request):
    no = request.GET.get("sno")
    cname = request.GET.get("sname")
    d1 = {"cno": no, "cname": cname}
    return render(request, "p_admin/open_city.html", {"update_data": d1,"cdata": CityModel.objects.all()})
...
def open_area(request):
    return render(request, 'p_admin/open_area.html', {"sf": AreaForm(), "adata": AreaModel.objects.all()})
...
def save_area(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "p_admin/open_area.html", {"sf": sf})
def update_area(request):
    no = request.GET.get("ano")
    aname = request.GET.get("aname")
    d1 = {"ano": no, "aname": aname}
    return render(request, "p_admin/open_area.html", {"update_data": d1, "adata": AreaModel.objects.all()})
...
def open_type(request):
    return render(request, 'p_admin/open_type.html', {"sf": RestaurantTypeForm(), "tdata": RestaurantTypeModel.objects.all()})
...
def save_type(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "p_admin/open_type.html", {"sf": sf})

def update_type(request):
    tno = request.GET.get("tno")
    tname = request.GET.get("tname")
    d1 = {"tno": tno, "tname": tname}
    return render(request, "p_admin/open_type.html", {"update_data": d1, "tdata": RestaurantTypeModel.objects.all()})
