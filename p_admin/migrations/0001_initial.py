# Generated by Django 3.0 on 2020-04-16 13:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='p_admin.StateModel')),
            ],
        ),
        migrations.CreateModel(
            name='AreaModel',
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='p_admin.CityModel')),
            ],
        ),
    ]
